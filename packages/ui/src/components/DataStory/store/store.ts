...
export const useStoreArray: Array<UseBoundStoreWithEqualityFn<StoreApi<StoreSchema>>> = [];

for(let i = 0; i < 10; i ++)
{
  const useStore = createWithEqualityFn<StoreSchema>((set, get) => ({
    //DEFAULTS
