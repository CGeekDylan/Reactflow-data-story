...
function DataStoryApp({ defaultFlowName, flow }) {
    ...
    const { flowName, setFlowName, open } = store_1.useStoreArray[0](selector, shallow_1.shallow);
    (0, react_1.useEffect)(() => {
        if (flow)
