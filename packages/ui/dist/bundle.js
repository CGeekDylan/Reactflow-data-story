...
const DataStory = ({ server, diagram, id, callback }) => {
    return ((0, jsx_runtime_1.jsx)(Workbench_1.Workbench, { server: server, diagram: diagram, id: id, callback: callback }));
};
...
const traditional_1 = __webpack_require__(/*! zustand/traditional */ "../../node_modules/zustand/esm/traditional.js");
...
const Workbench = ({ server, diagram, id, callback }) => {
    ...
    const { connect, nodes, edges, onNodesChange, onEdgesChange, onInit, openNodeModalId, setOpenNodeModalId, traverseNodes } = (0, traditional_1.useStoreWithEqualityFn)(store_1.useStoreArray[id], selector, shallow_1.shallow);
    ...
    return ((0, jsx_runtime_1.jsxs)(reactflow_1.ReactFlowProvider, { children: [(0, jsx_runtime_1.jsxs)(reactflow_1.default, Object.assign({ className: "bg-gray-50", nodes: nodes, edges: edges, nodeTypes: nodeTypes, onNodesChange: onNodesChange, onEdgesChange: onEdgesChange, onConnect: connect, onInit: (rfInstance) => {
                    onInit({
                        rfInstance,
                        server,
                        diagram,
                ...
                }, minZoom: 0.25, maxZoom: 8 }, { children: [(0, jsx_runtime_1.jsx)(dataStoryControls_1.DataStoryControls, { setShowRunModal: setShowRunModal, setShowAddNodeModal: setShowAddNodeModal, setShowConfigModal: setShowConfigModal, id: id }), (0, jsx_runtime_1.jsx)(reactflow_1.Background, { color: "#E7E7E7", variant: reactflow_1.BackgroundVariant.Lines })] })), showConfigModal && (0, jsx_runtime_1.jsx)(configModal_1.ConfigModal, { setShowModal: setShowConfigModal, id: id }), showRunModal && (0, jsx_runtime_1.jsx)(runModal_1.RunModal, { setShowModal: setShowRunModal, id: id }), showAddNodeModal && (0, jsx_runtime_1.jsx)(addNodeModal_1.AddNodeModal, { setShowModal: setShowAddNodeModal, id: id }), openNodeModalId && (0, jsx_runtime_1.jsx)(nodeSettingsModal_1.NodeSettingsModal, { id: id })] }));
};
...
// setShowConfigModal,
setShowRunModal, setShowAddNodeModal, setShowConfigModal, id, }) {
    // const router = useRouter();
    const selector = (state) => ({
        onSave: state.onSave,
    });
    const { onSave } = store_1.useStoreArray[id](selector, shallow_1.shallow);
...
const store_1 = __webpack_require__(/*! ../store/store */ "./dist/components/DataStory/store/store.js");
const AddNodeModal = ({ setShowModal, id }) => {
    ...
    const { toDiagram, nodes, edges, addNode, connect, availableNodes } = store_1.useStoreArray[id](selector, shallow_1.shallow);
...
const store_1 = __webpack_require__(/*! ../store/store */ "./dist/components/DataStory/store/store.js");
const core_1 = __webpack_require__(/*! @data-story/core */ "../core/dist/index.js");
const ConfigModal = ({ setShowModal, id }) => {
    const selector = (state) => ({
        serverConfig: state.serverConfig,
        setServerConfig: state.setServerConfig,
    });
    const { serverConfig, setServerConfig } = store_1.useStoreArray[id](selector, shallow_1.shallow);
...
const NodeSettingsModal = ({ id }) => {
    ...
    const { nodes, openNodeModalId, setOpenNodeModalId, setNodes } = store_1.useStoreArray[id](selector, shallow_1.shallow);
...
const store_1 = __webpack_require__(/*! ../store/store */ "./dist/components/DataStory/store/store.js");
const react_1 = __webpack_require__(/*! react */ "react");
const RunModal = ({ setShowModal, id }) => {
    ...
    const { onRun, serverConfig } = store_1.useStoreArray[id](selector, shallow_1.shallow);
...
exports.useStoreArray = [];
for (let i = 0; i < 10; i++) {
    const useStore = (0, traditional_1.createWithEqualityFn)((set, get) => ({
        //DEFAULTS
    ...
    exports.useStoreArray.push(useStore);
}
...
const DataStoryCommentNodeComponent = ({ id, data }) => {
    ...
    const { setOpenNodeModalId } = store_1.useStoreArray[0](selector, shallow_1.shallow);
